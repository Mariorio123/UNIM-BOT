...
SALON_BIENVENUE_ID = 1501257698300268554  # ID du salon d'accueil
SALON_TWITTER_ID = 1540447152050933820    # ID du salon #twitter
SALON_SNAP_ID = 1540447072501633105    # ID du salon #threads
SALON_INSTAGRAM_ID = 1540447221516869793  # ID du salon #instagram
    ...
    if salon:
        embed = discord.Embed(
            ...
            description=(
                ...
                f"tu peux bosser soit sur **Twitter** 🐦, soit sur **Snap** 🧵, "
